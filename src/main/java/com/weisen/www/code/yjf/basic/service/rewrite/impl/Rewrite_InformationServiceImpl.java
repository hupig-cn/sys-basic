...
public class Rewrite_InformationServiceImpl implements Rewrite_InformationService {
	...
	public Rewrite_InformationServiceImpl(Rewrite_UserRepository rewrite_UserRepository,
			Rewrite_InformationRepository rewrite_informationRepository,
			Rewrite_InformationMapper rewrite_informationMapper) {
...
//                }
	...
	public Result readInformation(Long id, String userId) {
		if (!CheckUtils.checkLongByZero(id))
			...
			Optional<Information> informationByUserIdAndId = rewrite_informationRepository
					.findInformationByUserIdAndId(userId, id);
	...
	public Result getInformations(Rewrite_InformationDetailsDTO details) {
		if (!CheckUtils.checkString(details.getUserId()))
			...
			List<Information> informations = rewrite_informationRepository.getInformations(details.getUserId(),
					details.getPageNum() * details.getPageSize(), details.getPageSize());
	...
	public Result deleteUserInformations(String userId) {
		...
		if (informationList.isEmpty()) {
			...
			for (Information information : informationList) {
				information.setLogicdelete(true);
				rewrite_informationRepository.saveAndFlush(information);
			}
			return Result.suc("删除成功!");
		}
	}
