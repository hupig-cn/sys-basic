...
public class Rewrite_IncomeDetailsResource {
	...
	@ApiOperation("收益列表")
	public ResponseEntity<?> getProfitList2(@RequestParam String userId) {
		Result result = incomeDetailsService.getProfitList2(userId);
	...
	@ApiOperation("查询推荐榜前十位用户")
	public ResponseEntity<Result> recommendationList(@RequestParam String userId) {
		Result result = incomeDetailsService.recommendationList(userId);
