...
public class DeviceinfobeanResourceIT {
    ...
    public static Deviceinfobean createEntity(EntityManager em) {
        Deviceinfobean deviceinfobean = new Deviceinfobean()
            .platformandroid(DEFAULT_PLATFORMANDROID)
            .platformios(DEFAULT_PLATFORMIOS)
            .userid(DEFAULT_USERID)
            .platformname(DEFAULT_PLATFORMNAME)
            .devicemanufacturer(DEFAULT_DEVICEMANUFACTURER)
            .devicemodel(DEFAULT_DEVICEMODEL)
            .deviceabis(DEFAULT_DEVICEABIS)
            .sdkversionname(DEFAULT_SDKVERSIONNAME)
            .sdkversioncode(DEFAULT_SDKVERSIONCODE)
            .romname(DEFAULT_ROMNAME)
            .romversion(DEFAULT_ROMVERSION)
            .screenwidth(DEFAULT_SCREENWIDTH)
            .screenheight(DEFAULT_SCREENHEIGHT)
            .appscreenwidth(DEFAULT_APPSCREENWIDTH)
            .appscreenheight(DEFAULT_APPSCREENHEIGHT)
            .screendensitydpi(DEFAULT_SCREENDENSITYDPI)
            .screendensity(DEFAULT_SCREENDENSITY)
            .appversionname(DEFAULT_APPVERSIONNAME)
            .appversioncode(DEFAULT_APPVERSIONCODE)
    ...
    public static Deviceinfobean createUpdatedEntity(EntityManager em) {
        Deviceinfobean deviceinfobean = new Deviceinfobean()
            .platformandroid(UPDATED_PLATFORMANDROID)
            .platformios(UPDATED_PLATFORMIOS)
            .userid(UPDATED_USERID)
            .platformname(UPDATED_PLATFORMNAME)
            .devicemanufacturer(UPDATED_DEVICEMANUFACTURER)
            .devicemodel(UPDATED_DEVICEMODEL)
            .deviceabis(UPDATED_DEVICEABIS)
            .sdkversionname(UPDATED_SDKVERSIONNAME)
            .sdkversioncode(UPDATED_SDKVERSIONCODE)
            .romname(UPDATED_ROMNAME)
            .romversion(UPDATED_ROMVERSION)
            .screenwidth(UPDATED_SCREENWIDTH)
            .screenheight(UPDATED_SCREENHEIGHT)
            .appscreenwidth(UPDATED_APPSCREENWIDTH)
            .appscreenheight(UPDATED_APPSCREENHEIGHT)
            .screendensitydpi(UPDATED_SCREENDENSITYDPI)
            .screendensity(UPDATED_SCREENDENSITY)
            .appversionname(UPDATED_APPVERSIONNAME)
            .appversioncode(UPDATED_APPVERSIONCODE)
    ...
    public void createDeviceinfobean() throws Exception {
        ...
        restDeviceinfobeanMockMvc.perform(post("/api/deviceinfobeans")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(deviceinfobean)))
        ...
        assertThat(testDeviceinfobean.getPlatformandroid()).isEqualTo(DEFAULT_PLATFORMANDROID);
        assertThat(testDeviceinfobean.getPlatformios()).isEqualTo(DEFAULT_PLATFORMIOS);
    ...
    public void getAllDeviceinfobeans() throws Exception {
        ...
        restDeviceinfobeanMockMvc.perform(get("/api/deviceinfobeans?sort=id,desc"))
    ...
    public void updateDeviceinfobean() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedDeviceinfobean are not directly saved in db
        em.detach(updatedDeviceinfobean);
        updatedDeviceinfobean
            .platformandroid(UPDATED_PLATFORMANDROID)
            .platformios(UPDATED_PLATFORMIOS)
            .userid(UPDATED_USERID)
            .platformname(UPDATED_PLATFORMNAME)
        ...
        restDeviceinfobeanMockMvc.perform(put("/api/deviceinfobeans")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(updatedDeviceinfobean)))
            .andExpect(status().isOk());
        ...
        Deviceinfobean testDeviceinfobean = deviceinfobeanList.get(deviceinfobeanList.size() - 1);
        assertThat(testDeviceinfobean.getPlatformandroid()).isEqualTo(UPDATED_PLATFORMANDROID);
        assertThat(testDeviceinfobean.getPlatformios()).isEqualTo(UPDATED_PLATFORMIOS);
    ...
    public void deleteDeviceinfobean() throws Exception {
        ...
        restDeviceinfobeanMockMvc.perform(delete("/api/deviceinfobeans/{id}", deviceinfobean.getId())
