...
public class FeedbackResourceIT {
    ...
    private static final String DEFAULT_FEEDBACKDATE = "AAAAAAAAAA";
    private static final String UPDATED_FEEDBACKDATE = "BBBBBBBBBB";
    ...
    public static Feedback createEntity(EntityManager em) {
        Feedback feedback = new Feedback()
            .name(DEFAULT_NAME)
            .feedbackdate(DEFAULT_FEEDBACKDATE)
            .title(DEFAULT_TITLE)
    ...
    public static Feedback createUpdatedEntity(EntityManager em) {
        Feedback feedback = new Feedback()
            .name(UPDATED_NAME)
            .feedbackdate(UPDATED_FEEDBACKDATE)
            .title(UPDATED_TITLE)
    ...
    public void createFeedback() throws Exception {
        ...
        assertThat(testFeedback.getFeedbackdate()).isEqualTo(DEFAULT_FEEDBACKDATE);
        assertThat(testFeedback.getTitle()).isEqualTo(DEFAULT_TITLE);
        assertThat(testFeedback.getContent()).isEqualTo(DEFAULT_CONTENT);
        assertThat(testFeedback.getState()).isEqualTo(DEFAULT_STATE);
        assertThat(testFeedback.getImageurl()).isEqualTo(DEFAULT_IMAGEURL);
        assertThat(testFeedback.getCreator()).isEqualTo(DEFAULT_CREATOR);
        assertThat(testFeedback.getCreatedate()).isEqualTo(DEFAULT_CREATEDATE);
        assertThat(testFeedback.getModifier()).isEqualTo(DEFAULT_MODIFIER);
        assertThat(testFeedback.getModifierdate()).isEqualTo(DEFAULT_MODIFIERDATE);
        assertThat(testFeedback.getModifiernum()).isEqualTo(DEFAULT_MODIFIERNUM);
        assertThat(testFeedback.isLogicdelete()).isEqualTo(DEFAULT_LOGICDELETE);
        assertThat(testFeedback.getOther()).isEqualTo(DEFAULT_OTHER);
    }
    ...
    public void getAllFeedbacks() throws Exception {
        ...
        restFeedbackMockMvc.perform(get("/api/feedbacks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].feedbackdate").value(hasItem(DEFAULT_FEEDBACKDATE.toString())))
    ...
    public void getFeedback() throws Exception {
        ...
        restFeedbackMockMvc.perform(get("/api/feedbacks/{id}", feedback.getId()))
            ...
            .andExpect(jsonPath("$.feedbackdate").value(DEFAULT_FEEDBACKDATE.toString()))
    ...
    public void updateFeedback() throws Exception {
        ...
        assertThat(testFeedback.getFeedbackdate()).isEqualTo(UPDATED_FEEDBACKDATE);
        assertThat(testFeedback.getTitle()).isEqualTo(UPDATED_TITLE);
        assertThat(testFeedback.getContent()).isEqualTo(UPDATED_CONTENT);
        assertThat(testFeedback.getState()).isEqualTo(UPDATED_STATE);
        assertThat(testFeedback.getImageurl()).isEqualTo(UPDATED_IMAGEURL);
        assertThat(testFeedback.getCreator()).isEqualTo(UPDATED_CREATOR);
        assertThat(testFeedback.getCreatedate()).isEqualTo(UPDATED_CREATEDATE);
        assertThat(testFeedback.getModifier()).isEqualTo(UPDATED_MODIFIER);
        assertThat(testFeedback.getModifierdate()).isEqualTo(UPDATED_MODIFIERDATE);
        assertThat(testFeedback.getModifiernum()).isEqualTo(UPDATED_MODIFIERNUM);
        assertThat(testFeedback.isLogicdelete()).isEqualTo(UPDATED_LOGICDELETE);
        assertThat(testFeedback.getOther()).isEqualTo(UPDATED_OTHER);
    }
